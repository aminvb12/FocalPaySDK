...
public struct ReceiptView : View {
    ...
    public init(userID: Binding<String> ,storeID: Binding<String> , orderID: Binding<String> ) {
    ...
    public var body: some View {
        ...
        VStack{
            PortalView(portal: .init(name: "webapp", startDir: "focalpayPortal",bundle: .module, initialContext:  [ "storeId": storeID , "orderId": orderID ]))
